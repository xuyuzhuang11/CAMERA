...
@torch.no_grad()
def phi_importance(model, dataloader, dev):
    print('Starting ...')
    ...
    for i in range(len(layers)):
        ...
        module = get_moe_module(layer, 'phi')
        mei = MEI(module, dev, tp='phi', batch_size=args.chunk_size, shape=inps.shape)
...
if __name__ == '__main__':
    ...
    if args.func == 'prune':
        ...
        tick = time.time()
        importances = phi_importance(model, dataloader, DEV)
